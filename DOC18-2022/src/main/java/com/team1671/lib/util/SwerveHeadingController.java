...
public class SwerveHeadingController {
	...
	public SwerveHeadingController(){
		if(Settings.kIsUsingTractionWheels){
			stabilizationPID = new SynchronousPIDF(0.006, 0.0, 0.001, 0.0); //keep wheels stationary 0.006
			snapPID = new SynchronousPIDF(0.02, 0.0, 0.0, 0.0); //0.02, 0.0, 0.0, 0.0 //for auto
			stationaryPID = new SynchronousPIDF(0.006, 0.0, 0.00015, 0.0); //stationary turn //0.0088
		}else{
			stabilizationPID = new SynchronousPIDF(0.006, 0.0, 0.001, 0.0); //move and turn
			snapPID = new SynchronousPIDF(0.04, 0.0, 0.0, 0.0); //0.02, 0.0, 0.0, 0.0
			stationaryPID = new SynchronousPIDF(0.0088, 0.0, 0.00025, 0.0); //stationary turn
		}
