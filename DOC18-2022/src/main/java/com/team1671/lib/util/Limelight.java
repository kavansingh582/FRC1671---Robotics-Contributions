...
public class Limelight {
    ...
    public static final double HEIGHT_OF_TARGET = 103.62;//in
    public static final double HEIGHT_OF_LIMELIGHT = 41.25;//in
    public static final double LIMELIGHT_MOUNTING_ANGLE = 30;//deg
