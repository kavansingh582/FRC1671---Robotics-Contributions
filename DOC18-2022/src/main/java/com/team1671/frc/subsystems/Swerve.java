...
public class Swerve extends Subsystem{
	...
	SynchronousPIDF lateralPID = new SynchronousPIDF(0.05, 0.0, 0.0); // 0.05, 0.0, 0.0
	SynchronousPIDF forwardPID = new SynchronousPIDF(0.05, 0.0, 0.0); // 0.02, 0.0, 0.0
	...
	Pose2d startingPose = Constants.testStartPose;
	...
	private double maxSpeedFactor = 0.6;
	...
	*/
	...
	public boolean[] isFunctional(){
		...
		boolean[] goods = new boolean[4];
		goods[0]=frontRight.isRotationSensorConnected();
		goods[1]=frontLeft.isRotationSensorConnected();
		goods[2]=rearLeft.isRotationSensorConnected();
		goods[3]=rearRight.isRotationSensorConnected();
		return goods;
	}
	...
	*/
	...
	public synchronized void zeroSensors() {
		zeroSensors(Constants.testStartPose);
	}
