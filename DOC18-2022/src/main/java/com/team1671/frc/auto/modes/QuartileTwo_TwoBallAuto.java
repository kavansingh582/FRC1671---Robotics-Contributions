...
public class QuartileTwo_TwoBallAuto extends AutoModeBase {
    Superstructure s;
    Swerve swerve;

    @Override
    public List<Trajectory<TimedState<Pose2dWithCurvature>>> getPaths() {
        return Arrays.asList(trajectories.Q2ToRedBall4);
    }
    
    public QuartileTwo_TwoBallAuto(){
    ...
    protected void routine() throws AutoModeEndedException {
        ...
        s.intakeState();
        runAction(new SetTrajectoryAction(trajectories.Q2ToRedBall4, 20, 7));
