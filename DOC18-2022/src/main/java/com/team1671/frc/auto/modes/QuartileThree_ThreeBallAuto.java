...
public class QuartileThree_ThreeBallAuto extends AutoModeBase {
    Superstructure s;
    Swerve swerve;

    @Override
    public List<Trajectory<TimedState<Pose2dWithCurvature>>> getPaths() {
        return Arrays.asList(trajectories.Q3ToBlueBall1, trajectories.BlueBall1toBall2);
    }
    
    public QuartileThree_ThreeBallAuto(){
    ...
    protected void routine() throws AutoModeEndedException {
        ...
        runAction(new ResetPoseAction(Constants.quartileThreeStartingPose));
        s.firingVisionState();
